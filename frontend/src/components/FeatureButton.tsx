...
export const FeatureButton: React.FC<FeatureButtonProps> = ({Icon, title, description, onClick}) => (<button
    onClick={onClick}
...
>
    <div
        className="absolute inset-0 border-2 border-transparent group-hover:border-red-500 rounded-2xl transition-all duration-300 pointer-events-none"></div>
