    ...
    const features = [
        {
            ...
            detail:
                "Our neural network analyzes 10+ variables including weather patterns, tire degradation curves, and lap Number to deliver predictions within 0.1 seconds of actual lap times.",
            route: '/predict',
        },
        {
            icon: BarChart3,
            ...
            detail:
                "From pit window optimization to tire compound selection, our AI processes millions of race scenarios to suggest championship-winning strategies.",
            route: '/strategy',
        },
    ];
            ...
            <div className="relative z-10 container mx-auto px-4 max-w-6xl py-10">
                <div className="text-center mb-16">
                    <div className="flex justify-center items-center mb-6 group">
                        <div className="relative p-1.5">
                            <Car className="w-16 h-16 text-red-400 mr-4 group-hover:scale-110 transition-transform duration-300 transform-gpu" />
                            <div className="absolute -inset-2.5 bg-red-500/30 rounded-full blur-xl opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
                        </div>
                        <div>
                            ...
                            <div className="h-1 bg-gradient-to-r from-red-500 to-orange-500 mx-auto mt-3 rounded-full shadow-lg w-40" />
                        </div>
                    </div>
                </div>

                <div className="text-center mb-16">
                    <div className="bg-black/50 backdrop-blur-xl border border-red-500/40 rounded-2xl p-8 max-w-4xl mx-auto shadow-2xl hover:border-red-400/60 transition-all duration-500 group relative overflow-hidden">
                        <div className="absolute inset-0 bg-gradient-to-r from-red-500/10 via-orange-500/10 to-red-500/10 opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
                        ...
                        <div className="relative z-10">
                            ...
                            <p className="text-lg text-gray-300 mb-6 max-w-2xl mx-auto leading-relaxed">
                                Jump straight into the action with our powerful pre-trained models, or unleash your
                                potential by training custom AI for unique insights. Your championship strategy starts
                                here.
                            </p>
                ...
                <div className="mb-16">
                                ...
                                >
                                    ...
                                    <div className="relative z-10">
                                        <div className="flex items-center mb-4">
                                            <div className="bg-red-500/20 p-3 rounded-xl mr-3 group-hover:bg-red-500/30 transition-colors duration-300 shadow-inner">
                                                <feature.icon className="w-6 h-6 text-red-400 group-hover:scale-110 transition-transform duration-300" />
                                            </div>
                                            <h4 className="text-xl font-bold text-white leading-snug">{feature.title}</h4>
                                        </div>

                                        <p className="text-gray-300 text-base leading-relaxed mb-3">{feature.description}</p>
                                        ...
                                        <div className="flex items-center text-red-400 font-semibold text-sm group-hover:text-red-300 transition-colors">
                                            ...
                                            <ChevronRight className="w-4 h-4 ml-1.5 group-hover:translate-x-2 transition-transform duration-300" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div className="text-center pt-10 border-t border-gray-700/50">
                        <p className="text-base text-gray-400 mb-3">Ready to elevate your F1 strategy?</p>
                    </div>
                </div>
            </div>
        </div>
