...
import {BarChart3, Home, Rocket, Settings, Zap} from 'lucide-react';
...
const toastColors = {
    success: 'bg-green-600', error: 'bg-red-600', info: 'bg-blue-600', warning: 'bg-yellow-400 text-black',
};
        ...
        <div className="container mx-auto max-w-5xl py-6">
            <div className="text-center mb-10">
                ...
                <p className="text-lg text-gray-300 max-w-3xl mx-auto leading-relaxed">
                    Harness the power of artificial intelligence to craft winning race strategies. Optimize tire
                    choices, predict pit stop windows, and react dynamically to race conditions.
                </p>
            </div>
            <div
                className="max-w-3xl mx-auto bg-black/60 backdrop-blur-lg border-t-4 border-red-600 rounded-2xl shadow-2xl p-8 transform transition-transform duration-500">
            ...
            {strategyResult && (<div
                className="mt-8 bg-black/60 backdrop-blur-md border border-red-500/40 rounded-2xl p-6 text-white shadow-xl max-w-3xl mx-auto transform transition-transform duration-500 hover:scale-[1.01]">
            ...
            <div className="fixed top-4 right-4 flex flex-col space-y-2 z-50 max-w-xs">
                {toasts.map(({id, title, message, type}) => (<div
                    key={id}
