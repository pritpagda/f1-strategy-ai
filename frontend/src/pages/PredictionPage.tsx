        ...
        <div className="container mx-auto max-w-5xl py-6">
            <div className="text-center mb-8">
                ...
                <p className="text-lg text-gray-300 max-w-2xl mx-auto leading-relaxed">
                    Unleash the power of AI to forecast precise lap times. Input key race parameters and witness the
                    predictive capabilities, guiding your team to optimal performance.
                </p>
            </div>
            <div
            ...
            {prediction !== null && (() => {
                ...
                return (<div
                    className="mt-8 bg-black/50 backdrop-blur-sm border border-red-500/30 rounded-xl p-6 text-center text-white text-3xl font-extrabold shadow-lg transition-all duration-500 transform scale-100 hover:scale-[1.01]">
